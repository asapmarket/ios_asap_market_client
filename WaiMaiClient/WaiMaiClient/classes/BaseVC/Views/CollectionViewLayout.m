...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.itemHeightBlock) itemHeight = self.itemHeightBlock(itemWidth, indexPath);
        ...
        if ([self.delegate respondsToSelector:@selector(collectionViewLayout:itemHeightForWidth:atIndexPath:)])
            itemHeight = [self.delegate collectionViewLayout:self itemHeightForWidth:itemWidth atIndexPath:indexPath];
    }
